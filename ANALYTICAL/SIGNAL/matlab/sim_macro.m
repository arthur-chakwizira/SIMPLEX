...
%MACRO for running simulations with the SIMPLEX framework (analytical version)
...
cu_path = [cuda_folder, '\simplex_cs.cu']; %path to cu source file
...
opt.SIGNAL_FILE_NAME = '..\output\test_signal.bin';
opt.SAVE_LAST_POSITIONS = 1; %1 = yes, 0 = no
opt.TRAJECTORY_FILE_NAME = '..\output\test_traj.bin';
opt.SAVE_STATE_HISTORY = 1; %1 = yes, 0 = no
opt.STATE_FILE_NAME = '..\output\test_stat.bin';
opt.SAVE_PHASE = 1; %1 = yes, 0 = no
opt.PHASE_FILE_NAME = '..\output\test_phase.bin';
