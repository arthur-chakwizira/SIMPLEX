...
if run_sim
    ...
    exe_fn = 'simplex_st.exe'; %executable name
    ...
    opt.TRAJECTORY_FILE_NAME = '..\output\test_traj_st.bin';
    opt.SAVE_STATE_HISTORY = 1; %1 = yes, 0 = no
    opt.STATE_FILE_NAME = '..\output\test_stat_st.bin';
...
num_k = 200;
Dw_theo = resex_mc_compute_dw_sphere(w, d, D0, num_k);
